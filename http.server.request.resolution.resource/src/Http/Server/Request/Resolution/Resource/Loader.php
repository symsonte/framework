...
use Symsonte\Http\Server\Request\Resolution\Bag;
...
class Loader
{
     ...
     *     normalizers:  '#symsonte.http.server.request.resolution.resource.normalizer',
     *     compilers:    '#symsonte.http.server.request.resolution.resource.compiler',
