    ...
    public function build()
    {
        ...
        $bag = new Bag(
            array_merge(
                ...
                [
                    'symsonte.service_kit.declaration.bag.composer_builder' => new Declaration(
                        new ConstructorDeclaration(
                            'symsonte.service_kit.declaration.bag.composer_builder',
                            'Symsonte\ServiceKit\Declaration\Bag\ComposerBuilder',
                            false,
                            [
                                new ServiceArgument('symsonte.service_kit.resource.cacher'),
        ...
        return new Bag(
            array_merge(
                ...
                [
                    'symsonte.service_kit.declaration.bag.parameter_builder' => new Declaration(
                        new ConstructorDeclaration(
