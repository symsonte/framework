...
class HeaderSearcher
{
    ...
    const KEY_ACCESS_CONTROL_ALLOW_ORIGIN = 'access-control-allow-origin';
    const KEY_ACCESS_CONTROL_ALLOW_CREDENTIALS = 'access-control-allow-credentials';
    const KEY_ACCESS_CONTROL_ALLOW_HEADERS = 'access-control-allow-headers';
